...
import os.abuyahya.theholyquran.other.Event
import os.abuyahya.theholyquran.other.Resource

class HolyQuranServiceConnection(
    ...
    private val _curPlayingSurah = MutableLiveData<MediaMetadataCompat?>()
    val curPlayingSurah: MutableLiveData<MediaMetadataCompat?> = _curPlayingSurah
    ...
    private val mediaBrowser = MediaBrowserCompat(
        context,
        ComponentName(
            context, HolyQuranService::class.java
        ),
    ...
    private inner class MediaControllerCallback: MediaControllerCompat.Callback() {
        ...
        override fun onMetadataChanged(metadata: MediaMetadataCompat?) {
            _curPlayingSurah.postValue(metadata)
        }
